...
#retornando somente o nome da editora
...
class LivroDetailSerializer(ModelSerializer):
    categoria = CharField(source="categoria.descricao")  #retornando somente a descricao da categoria
    ...
    def get_autores(self, instance): #retornando somente os nomes dos autores
        nomes_autores = []
